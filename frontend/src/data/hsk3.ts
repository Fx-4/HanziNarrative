    ...
    sessions: [
      {
        ...
        words: [
          ...
          { zh: '银行',  py: 'yínháng',   en: 'Bank',
            funFact: '银 = "silver" + 行 (háng) = "a business/firm". Old Chinese money was silver, so a place that dealt in silver was the "silver business" = a bank. Note 行 is read háng here (business), not xíng (to walk).' },
          { zh: '邮局',  py: 'yóujú',     en: 'Post office' },
          { zh: '医院',  py: 'yīyuàn',    en: 'Hospital',
            funFact: '医 = "to heal / medicine" + 院 = "courtyard / institution" → a "healing institution". 院 marks walled compounds and institutions — you\'ll also meet it in 学院 (college) and 电影院 (cinema).' },
    ...
    sessions: [
      {
        ...
        words: [
          { zh: '冰箱',  py: 'bīngxiāng', en: 'Refrigerator',
            funFact: '冰 = "ice" + 箱 = "box/chest" → literally an "ice box". Before electric fridges, food was kept cold in a box packed with ice, and the name carried over to the modern appliance.' },
          { zh: '洗衣机', py: 'xǐyījī',   en: 'Washing machine',
            funFact: '洗 = "wash" + 衣 = "clothes" + 机 = "machine" → a "wash-clothes machine". Chinese often builds appliance names as verb + object + 机, e.g. 洗碗机 (dishwasher).' },
          { zh: '空调',  py: 'kōngtiáo',  en: 'Air conditioning',
            funFact: '空 = "air" + 调 (tiáo) = "to adjust/regulate", short for 空气调节 "air regulation". So an AC literally "adjusts the air". 调 is read tiáo here (to adjust), not diào (tune).' },
          { zh: '电梯',  py: 'diàntī',    en: 'Elevator / Lift',
            funFact: '电 = "electric" + 梯 = "ladder/stairs" → an "electric staircase". The same 梯 gives 楼梯 (stairs) and 扶梯 (escalator).' },
      ...
      },
      {
        ...
        words: [
          ...
          { zh: '眼镜',  py: 'yǎnjìng',   en: 'Glasses / Eyeglasses',
            funFact: '眼 = "eye" + 镜 = "mirror/lens" → "eye lenses". 镜 is the same character in 镜子 (mirror) and 望远镜 (telescope = "look-far lens").' },
    ...
    sessions: [
      {
        ...
        words: [
          ...
          { zh: '历史',  py: 'lìshǐ',     en: 'History',
            funFact: '历 = "to pass through / experience" + 史 = "records / a scribe" → the "record of what has passed". 史 originally pictured a hand holding a tally — the court scribe who kept the records.' },
          { zh: '数学',  py: 'shùxué',    en: 'Mathematics',
            funFact: '数 = "number" + 学 = "study" → "the study of numbers". This 学 = "study of" builds most school subjects: 科学 (science), 化学 (chemistry), 文学 (literature).' },
