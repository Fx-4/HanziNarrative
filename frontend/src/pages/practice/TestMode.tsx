...
const MOTIVATIONAL_MESSAGES = [
  { Icon: Flame, iconClass: 'text-orange-500', title: "You're on fire!", message: 'Keep up the amazing work! Your Chinese is getting better with every answer.', color: 'from-orange-400 to-red-500', meme: { caption: 'me studying chinese at 3am', query: 'kung fu panda studying' } },
  ...
  { Icon: Target, iconClass: 'text-green-500', title: 'Right on target!', message: "Your focus is incredible! Keep that energy going - you got this!", color: 'from-green-400 to-blue-500', meme: { caption: 'chinese vocab test vs me', query: 'kung fu panda i am not afraid' } },
  ...
  { Icon: Gem, iconClass: 'text-indigo-500', title: 'Diamond in the making!', message: "Pressure makes diamonds, and you're forming into something brilliant!", color: 'from-indigo-400 to-purple-500', meme: { caption: 'hsk grind never stops', query: 'kung fu panda hard work discipline' } },
  ...
  { Icon: Flame, iconClass: 'text-red-500', title: 'Lowkey a Chinese genius rn', message: 'The way your brain is eating up these characters? Unreal.', color: 'from-red-400 to-orange-500', meme: { caption: 'my brain after learning 100 hanzi', query: 'chinese dragon powerful flying' } },
  ...
  { Icon: Rocket, iconClass: 'text-green-400', title: 'Speedrunning Chinese', message: "You're moving so fast through these characters. Absolute unit.", color: 'from-green-400 to-teal-500', meme: { caption: 'speedrunning hsk1 to hsk6', query: 'kung fu panda running fast dodge' } },
  ...
  { Icon: Target, iconClass: 'text-red-400', title: 'HSK? More like easy-SK', message: 'You make this look way too easy. Respect.', color: 'from-red-400 to-pink-500', meme: { caption: 'hsk exam after i studied', query: 'panda happy easy chill relaxed' } },
  { Icon: Gem, iconClass: 'text-cyan-400', title: 'Chinese vocab = unlocked', message: "Imagine knowing this much Chinese. Oh wait, that's you.", color: 'from-cyan-400 to-indigo-500', meme: { caption: 'knowing chinese in public', query: 'chinese martial arts cool impressive' } },
  { Icon: Flame, iconClass: 'text-amber-500', title: 'Bro is cooking fr', message: "You're in the zone. Every character is clicking. Don't stop!", color: 'from-amber-400 to-red-500', meme: { caption: 'me locked in on hsk study', query: 'kung fu panda focus concentrate meditation' } },
  ...
  { Icon: Trophy, iconClass: 'text-lime-500', title: 'HSK grind = locked in', message: "The grind never stops for real ones. You're locked in.", color: 'from-lime-400 to-green-500', meme: { caption: 'me after 5 correct hsk answers', query: 'kung fu panda victory celebrate champion' } },
  ...
  { Icon: BookOpen, iconClass: 'text-rose-400', title: 'Sleep is for after HSK', message: 'Just kidding, sleep is important. But first — 5 more questions.', color: 'from-rose-400 to-red-500', meme: { caption: 'me choosing chinese study over sleep', query: 'panda tired sleepy exhausted funny' } },
  ...
  { Icon: Sparkles, iconClass: 'text-green-400', title: '汉字? No problem!', message: "Look at you reading Chinese characters like it's nothing. Respect.", color: 'from-green-400 to-emerald-500', meme: { caption: 'me reading hanzi like its easy', query: 'chinese new year dragon dance happy' } },
]
      ...
      <div className="max-w-2xl mx-auto px-3 sm:px-4 pb-8">
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 p-8 sm:p-12 text-center mb-6">
          <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', duration: 0.6 }}>
            ...
            <div className="text-5xl font-extrabold text-indigo-600 dark:text-indigo-400 mb-6">{percentage}%</div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {showResult && isCorrect && <CheckCircle className="w-6 h-6 text-green-500 dark:text-green-400" />}
                      {showResult && isSelected && !isCorrect && <XCircle className="w-6 h-6 text-red-500 dark:text-red-400" />}
                    </div>
                  </button>
                )
              })}
